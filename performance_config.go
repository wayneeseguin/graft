...
type CacheConfiguration struct {
	ExpressionCacheSize int                       `yaml:"expression_cache_size" env:"SPRUCE_EXPRESSION_CACHE_SIZE" default:"10000"`
	OperatorCacheSize   int                       `yaml:"operator_cache_size" env:"SPRUCE_OPERATOR_CACHE_SIZE" default:"50000"`
	TokenCacheSize      int                       `yaml:"token_cache_size" env:"SPRUCE_TOKEN_CACHE_SIZE" default:"20000"`
	TTLSeconds          int                       `yaml:"ttl_seconds" env:"SPRUCE_CACHE_TTL" default:"3600"`
...
type HierarchicalCacheSettings struct {
	L1Size              int  `yaml:"l1_size" env:"SPRUCE_L1_CACHE_SIZE" default:"1000"`
	L2Size              int  `yaml:"l2_size" env:"SPRUCE_L2_CACHE_SIZE" default:"10000"`
	L2Enabled           bool `yaml:"l2_enabled" env:"SPRUCE_L2_ENABLED" default:"true"`
	SyncIntervalSeconds int  `yaml:"sync_interval_seconds" env:"SPRUCE_L2_SYNC_INTERVAL" default:"300"`
}

// CacheWarmingConfiguration for cache warming settings
type CacheWarmingConfiguration struct {
	Enabled               bool   `yaml:"enabled" env:"SPRUCE_CACHE_WARMING_ENABLED" default:"true"`
	Strategy              string `yaml:"strategy" env:"SPRUCE_CACHE_WARMING_STRATEGY" default:"hybrid"`
	StartupTimeoutSeconds int    `yaml:"startup_timeout_seconds" env:"SPRUCE_STARTUP_TIMEOUT" default:"30"`
	TopExpressions        int    `yaml:"top_expressions" env:"SPRUCE_TOP_EXPRESSIONS" default:"50"`
}

// ConcurrencyConfiguration holds concurrency-related settings
type ConcurrencyConfiguration struct {
	MaxWorkers            int                     `yaml:"max_workers" env:"SPRUCE_MAX_WORKERS" default:"100"`
	QueueSize             int                     `yaml:"queue_size" env:"SPRUCE_QUEUE_SIZE" default:"1000"`
	WorkerIdleTimeoutSecs int                     `yaml:"worker_idle_timeout_seconds" env:"SPRUCE_WORKER_IDLE_TIMEOUT" default:"60"`
	RateLimit             RateLimitConfiguration  `yaml:"rate_limit"`
}

// RateLimitConfiguration for rate limiting settings
type RateLimitConfiguration struct {
	Enabled            bool `yaml:"enabled" env:"SPRUCE_RATE_LIMIT_ENABLED" default:"true"`
	RequestsPerSecond  int  `yaml:"requests_per_second" env:"SPRUCE_RPS" default:"1000"`
	BurstSize          int  `yaml:"burst_size" env:"SPRUCE_BURST_SIZE" default:"100"`
}

// MemoryConfiguration holds memory-related settings
type MemoryConfiguration struct {
	MaxHeapMB       int                      `yaml:"max_heap_mb" env:"SPRUCE_MAX_HEAP_MB" default:"4096"`
...
type PoolConfiguration struct {
	BufferPool     int `yaml:"buffer_pool" env:"SPRUCE_BUFFER_POOL_SIZE" default:"1000"`
	StringSlicePool int `yaml:"string_slice_pool" env:"SPRUCE_STRING_SLICE_POOL_SIZE" default:"5000"`
	TokenPool      int `yaml:"token_pool" env:"SPRUCE_TOKEN_POOL_SIZE" default:"10000"`
}

// StringInterningConfig for string interning settings
type StringInterningConfig struct {
	Enabled    bool `yaml:"enabled" env:"SPRUCE_STRING_INTERNING_ENABLED" default:"true"`
	MaxEntries int  `yaml:"max_entries" env:"SPRUCE_STRING_INTERNING_MAX" default:"10000"`
}
...
type MemoizationConfig struct {
	Enabled    bool `yaml:"enabled" env:"SPRUCE_MEMOIZATION_ENABLED" default:"true"`
	CacheSize  int  `yaml:"cache_size" env:"SPRUCE_MEMOIZATION_CACHE_SIZE" default:"5000"`
	TTLSeconds int  `yaml:"ttl_seconds" env:"SPRUCE_MEMOIZATION_TTL" default:"1800"`
}

// LazyEvaluationConfig for lazy evaluation settings
type LazyEvaluationConfig struct {
	Enabled            bool     `yaml:"enabled" env:"SPRUCE_LAZY_EVAL_ENABLED" default:"true"`
	ExpensiveOperators []string `yaml:"expensive_operators"`
}

// IOConfiguration holds I/O-related settings
type IOConfiguration struct {
	ConnectionPoolSize    int                `yaml:"connection_pool_size" env:"SPRUCE_CONN_POOL_SIZE" default:"50"`
	RequestTimeoutSeconds int                `yaml:"request_timeout_seconds" env:"SPRUCE_REQUEST_TIMEOUT" default:"30"`
	RetryAttempts         int                `yaml:"retry_attempts" env:"SPRUCE_RETRY_ATTEMPTS" default:"3"`
	RetryBackoffSeconds   int                `yaml:"retry_backoff_seconds" env:"SPRUCE_RETRY_BACKOFF" default:"1"`
	Deduplication         DeduplicationConfig `yaml:"deduplication"`
}

// DeduplicationConfig for I/O deduplication settings
type DeduplicationConfig struct {
	Enabled       bool `yaml:"enabled" env:"SPRUCE_DEDUP_ENABLED" default:"true"`
	WindowSeconds int  `yaml:"window_seconds" env:"SPRUCE_DEDUP_WINDOW" default:"5"`
	MaxPending    int  `yaml:"max_pending" env:"SPRUCE_DEDUP_MAX_PENDING" default:"100"`
}

// MonitoringConfiguration holds monitoring-related settings
type MonitoringConfiguration struct {
	MetricsEnabled             bool `yaml:"metrics_enabled" env:"SPRUCE_METRICS_ENABLED" default:"true"`
	MetricsIntervalSeconds     int  `yaml:"metrics_interval_seconds" env:"SPRUCE_METRICS_INTERVAL" default:"60"`
	PerformanceTracking        bool `yaml:"performance_tracking" env:"SPRUCE_PERF_TRACKING" default:"true"`
	SlowOperationThresholdMs   int  `yaml:"slow_operation_threshold_ms" env:"SPRUCE_SLOW_OP_THRESHOLD" default:"100"`
}

// AutoTuningConfiguration holds auto-tuning settings
type AutoTuningConfiguration struct {
	Enabled                  bool    `yaml:"enabled" env:"SPRUCE_AUTO_TUNING_ENABLED" default:"false"`
	AnalysisIntervalSeconds  int     `yaml:"analysis_interval_seconds" env:"SPRUCE_ANALYSIS_INTERVAL" default:"300"`
	AdjustmentThreshold      float64 `yaml:"adjustment_threshold" env:"SPRUCE_ADJUSTMENT_THRESHOLD" default:"0.1"`
	MaxAdjustmentsPerHour    int     `yaml:"max_adjustments_per_hour" env:"SPRUCE_MAX_ADJUSTMENTS" default:"6"`
}
